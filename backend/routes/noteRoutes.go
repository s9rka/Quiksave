...
func GetNotes(w http.ResponseWriter, r *http.Request) {
	...
	notes, err := database.GetNotesFromDB(userID, vaultID)
	if err != nil {
...
func GetNoteByID(w http.ResponseWriter, r *http.Request) {
	...
	note, err := database.GetNoteByIDFromDB(noteID, userID, vaultID)
	if err != nil {
...
func DeleteNote(w http.ResponseWriter, r *http.Request) {
	...
	err = database.DeleteNoteFromDB(noteID, userID, vaultID)
	if err != nil {
		if strings.Contains(err.Error(), "not found") {
			http.Error(w, "Note not found", http.StatusNotFound)
		} else {
...
func EditNote(w http.ResponseWriter, r *http.Request) {
	...
	err = database.UpdateNoteInDB(noteID, userID, vaultID, noteData)
	if err != nil {
		if strings.Contains(err.Error(), "not found") {
			http.Error(w, "Note not found", http.StatusNotFound)
		} else {
	...
	updatedNote, err := database.GetNoteByIDFromDB(noteID, userID, vaultID)
	if err != nil {
